...
function addAccessors($scope) {
    ...
    $scope.setHeight = function(value) {
        setActiveStyle('height', parseInt(value, 10));
        setActiveStyle('scaleY', 1);
    };
    $scope.getWidth = function() {
        return getActiveStyle('width') * getActiveStyle('scaleX');
    };
    $scope.setWidth = function(value) {
        setActiveStyle('width', parseInt(value, 10));
        setActiveStyle('scaleX', 1);
    };
    ...
    $scope.rasterizeSVG = function() {
        window.open(
            ...
            encodeURIComponent(canvas.toSVG()), 'Download');
    };

...
%TODO: popisat ako je naprogramovany technologie kniznice

\subsection{MediaWiki rozšírenie}
%TODO: popisat ako som to integroval do mediawiki, extension.json, strukturu fileov, webhooky, special page, template page, preklady, ukladanie revizii,....

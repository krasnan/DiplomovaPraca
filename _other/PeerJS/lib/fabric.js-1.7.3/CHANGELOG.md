...
- Fix: Shift unselect activegroup on transformed $scope.canvas. [#3144](https://github.com/kangax/fabric.js/pull/3144)
...
- Fix: Remove reference to lastRenderedObject on $scope.canvas.remove [#3023](https://github.com/kangax/fabric.js/pull/3023)
